...
% init_val_vec_primary =   [A10  S0  (RNP1+RNP2) (RNP1) (RNP2) 0]; % primary only
% init_val_vec_neg =    [0  S0  (RNP1+RNP2) (RNP1) (RNP2) 0]; % no activators
% init_val_vec_cage =   [0  S0  (RNP1+RNP2) (RNP1) (RNP2) IA2]; % Cage only
% init_val_vec_ncr =    [A10  S0  (RNP1+RNP2) (RNP1) (RNP2) IA2]; % NCR


init_val_vec_primary =   [A10  S0  (RNP1) (RNP1) 0 0]; % primary only
init_val_vec_neg =    [0  S0  (RNP1) (RNP1) 0 0]; % no activators
...
% this)
% param order [ b, k, kc, kd_cga, kdeg, rcg, rcga, rga, ria, rns]
sigma_vec = [1e6, 1e0, 1e0, 1e0, 1e0, 1e0, 1e0, 1e0, 1e6, 1e0];
...
%adding ncr data
% fluo_cell_raw{4}=exp_data.x1_20nM_0_05nM_0_02_20_NCR061-exp_data.x1_20nM_0_05nM_0_02_20_NCR061(1);
